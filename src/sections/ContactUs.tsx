...
const ContactUs = () => {
  return (
    <Container bgPrimary className='' >
      <div id='contact' style={{ backgroundImage: `url('${coverImg}')` }} className='min-h-screen bg-cover bg-center flex flex-col lg:flex-row items-center justify-center w-full px-10 lg:px-20'>
